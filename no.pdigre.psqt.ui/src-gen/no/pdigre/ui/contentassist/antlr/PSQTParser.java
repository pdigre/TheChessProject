		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRow1Access().getGroup(), "rule__Row1__Group__0");
					...
					put(grammarAccess.getMRowAccess().getNameAssignment(), "rule__MRow__NameAssignment");
					put(grammarAccess.getERowAccess().getNameAssignment(), "rule__ERow__NameAssignment");
					put(grammarAccess.getRow1Access().getCAssignment_0(), "rule__Row1__CAssignment_0");
					put(grammarAccess.getRow1Access().getCAssignment_1(), "rule__Row1__CAssignment_1");
					put(grammarAccess.getRow1Access().getCAssignment_2(), "rule__Row1__CAssignment_2");
					put(grammarAccess.getRow1Access().getCAssignment_3(), "rule__Row1__CAssignment_3");
					put(grammarAccess.getRow1Access().getCAssignment_4(), "rule__Row1__CAssignment_4");
					put(grammarAccess.getRow1Access().getCAssignment_5(), "rule__Row1__CAssignment_5");
					put(grammarAccess.getRow1Access().getCAssignment_6(), "rule__Row1__CAssignment_6");
					put(grammarAccess.getRow1Access().getCAssignment_7(), "rule__Row1__CAssignment_7");
				}
			};
		}
