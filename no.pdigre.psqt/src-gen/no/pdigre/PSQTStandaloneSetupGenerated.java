...
public class PSQTStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new no.pdigre.PSQTRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.pdigre.no/PSQT")) {
		EPackage.Registry.INSTANCE.put("http://www.pdigre.no/PSQT", no.pdigre.pSQT.PSQTPackage.eINSTANCE);
	}
